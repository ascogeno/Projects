...
def test_pressure_loss_from_fittings():
    ...
    assert pressure_loss_from_fittings(1.65, 2) == approx(-0.109,0.005) #this no work with 0.001???????
    assert pressure_loss_from_fittings(1.75, 2) == approx(-0.122,0.005) #this one too
