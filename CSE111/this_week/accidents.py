...
def main():
    ...
    try:
        ...
        # Prompt the user for a percentage.
            ...
            if perc_reduc < 0:
                return print(f"Error: {perc_reduc} is too low. Please enter a different number.")
            elif perc_reduc > 100:
                return print(f"Error: {perc_reduc} is too high. Please enter a different number.")
            else: 
                print()
    ...
    except ValueError as valbad:
        print(f"Error: {valbad}")
