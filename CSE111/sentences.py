...
def main():
    ...
    """
    global kerm
    kerm = input("Would you like to activate Kermit mode?(Y/N): ")
    kerm = kerm.lower()
    if kerm == "y":
        print("Excellent choice, friend. Let me tell you about Kermit: \n")
    else:
        print("You must lead a truly boring life. But alas, it is your choice to read such comparative droll: \n")
...
def make_sentence(quantity, tense):
    ...
    if kerm == "y":
        sentence = sentence = f"{get_noun(quantity)} {get_verb(quantity,tense)} {get_prepositional_phrase(quantity)}."
    return sentence
...
def get_prepositional_phrase(quantity):
    ...
    if kerm == "y":
        phrase = f"{get_preposition()} {get_noun(quantity)}"
    return phrase
